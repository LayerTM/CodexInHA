...
ALLOW = re.compile(
    ...
    r"your[-_]?|xxxx|<[a-z0-9_.\-]+>|\$\{?[a-z_]+\}?|sk-(?:ant-|proj-)?\.\.\.)"
)
...
PATTERNS: dict[str, "re.Pattern[str]"] = {
    ...
    # Project, service-account and admin keys carry a prefix; legacy user keys
    # are a bare run of letters and digits.
    "OpenAI API key": re.compile(
        r"\bsk-(?:proj|svcacct|admin)-[A-Za-z0-9_-]{20,}|\bsk-[A-Za-z0-9]{32,}\b"
    ),
